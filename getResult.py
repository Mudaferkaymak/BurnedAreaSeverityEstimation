...
path = 'C:\\Users\\MÜDAFERKAYMAK\\Desktop\\Ara Proje\\Implementation\\burned-area-baseline\\OrnekResimler\\orn3.tiff'
...
model.load_state_dict(torch.load('C:\\Users\\MÜDAFERKAYMAK\\logs\\burned_area_dataset_paper\\binary_unet_dice\\checkpoint.pt', map_location=torch.device('cpu')))
model.eval()
...
plt.imshow(output_single_channel, cmap='gray')
plt.axis('off')
plt.show()

plt.imsave('ornek3torchOut.png', output_single_channel, cmap='gray')
